...
class SizeerMonitor:
    ...
    def __init__(self, threads_number=5,  # Number of Threads for Monitoring
        ...
        self.store_name = 'SIZEER DE'
        self.abreviation = "  [DE]"
        self.home_link = 'https://sizeer.de'
    ...
    def set_old_bot_conditions(self, prod_link, prod_sizes_number, prod_id):
        ...
        worth_items_list = [
            ...
            'DD1391-102',  # UNCs
            'DD1391-002',  # UNLV
            'DD1503-104',  # Barely Green
            'DH0957-100',  # Grey Camo
            ...
            'CZ2496-100',  # Free 99 White GS
            'DB1909-100',  # Dark Camo GS
            'DO6485-600',  # Velvet Pinks GS
            'DD1869-107',  # Alluminium Highs
            'DD1503-111',  # Archeo Pinks
            'DQ8580-100',  # Vintage Green
            'DD1503-115',  # Vintage Navy
            'DD1503-118',  # Rose Whisper
            'DH4401-101',  # Paisley Pack Blue
            'DH4401-102',  # Paisley Pack Green
            'DH4401-100',  # Paisley Pack Black
            'DH4401-104',  # Paisley Pack Barley
            'DH4401-103',  # Paisley Pack Orange
            'DJ6188-001',  # Two tone Grey
            'DD1391-601',  # Team Red Dunks
            'DO6723-800',  # Winter Solstice
            'DN1431-100',  # Next Nature Orewood Brown
            'DN1431-102',  # Next Nature White Mint
            'CW1590-600',  # Championship Reds GS
            'DD1391-600',  # Championship Reds
            'DO6723-800',  # Winter Solstice
            'DD1869-110',  # Pink Prime Highs
            'DB2179-105',  # Khaki Highs GS
            'DD1869-103',  # Pandas Highs W
        ]
        ...
        special_items_list = [
            ...
            'DN4321-100',  # Mids Diamond Short GS
            ...
            '555112-105',  # Mids Geometric Print GS
            '852542-801',  # Mids Hyper Pink
            '554725-132',  # Mids Igloos
            '852542-105',  # Mids SE Purple
            'DD9315-600',  # Lows Golf Chicago
            'DD9315-100',  # Lows Golf UNC
            '553558-030',  # Lows Smoke Greys
            'DC6991-200',  # Lows Mocha
            'DM0589-200',  # Lows Mocha GS
    ...
    def keywords_endpoint_prelucrator(self):
        ...
        if self.category == 'dunks':
            ...
            self.endpoint = 'https://sizeer.de/nike-dunk'
        else:
            self.filename = 'jordans.json'
            self.endpoint = 'https://sizeer.de/jordan-air-1'
    ...
    def set_starting_cookies(self, client, user_agent, thread_number):
        ...
        url = f'https://sizeer.de/manifest.json?{ran1}={ran2}'
        headers = {
            'authority': 'sizeer.de',
            'pragma': 'no-cache',
    ...
    def scrape_items(self, client, user_agent, thread_number):
        ...
        headers = {
            ...
            'reffer': 'https://sizeer.de/manifest.json',
            'accept-language': 'en-US,en;q=0.9',
        }
                ...
                for product in products_list:
                    ...
                    if prod_sizes_no:
                        ...
                        if prod_id_dict not in self.old_prods_list and prod_id_dict not in self.queued_items:
                            ...
                            product_price = product['data-price'] + ' EUR'
    ...
    def ping_detailed_item(self, client, user_agent, resell_platforms, prod_link,
        ...
        de_region = "[DE   :flag_de:](https://sizeer.de/)"
        ...
        fullEmbed.add_field(name="**REGION**", value=de_region, inline=True)
    ...
    def create_utilities(self):
        ...
        # Links
        checkout_last_step = 'https://sizeer.de/warenkorb/zusammenfassung'
        login_link = 'https://sizeer.de/login'
        address = 'https://sizeer.de/warenkorb/adresse'
