...
class SizeerMonitor:
    ...
    def set_old_bot_conditions(self, prod_link, prod_sizes_number, prod_id):
        ...
        special_items_list = [
            ...
            '553558-411',  # Lows Dark Teal
            '553558-040',  # Lows Black White Grey 2021
            '553560-040',  # Lows Black White Grey 2021 GS
            '553560-039',  # Lows Grey Toe GS
    ...
    def keywords_endpoint_prelucrator(self):
        ...
        if self.category == 'dunks':
            ...
            self.endpoint = 'https://sizeer.ro/nike-dunk'
        else:
            self.filename = 'jordans.json'
            self.endpoint = 'https://sizeer.ro/jordan-air-1'
    ...
    def set_starting_cookies(self, client, user_agent, thread_number):
        ...
        url = f'https://sizeer.ro/manifest.json?{ran1}={ran2}'
        headers = {
            'authority': 'sizeer.ro',
            'pragma': 'no-cache',
    ...
    def scrape_items(self, client, user_agent, thread_number):
        ...
        headers = {
            ...
            'reffer': 'https://sizeer.ro/manifest.json',
            'accept-language': 'en-US,en;q=0.9',
        }
    ...
    def ping_detailed_item(self, client, user_agent, resell_platforms, prod_link,
        ...
        ro_region = "[RO   :flag_ro:](https://sizeer.ro/)"
        ...
        fullEmbed.add_field(name="**REGION**", value=ro_region, inline=True)
        fullEmbed.add_field(name="**UTILITIES**", value=utilities, inline=False)
        fullEmbed.set_footer(text=f"Written & performed by Cirlea Mihai • {datetime.datetime.now()}",
                             icon_url=self.banner_image)
